...
Developed by Michael Brown as an academic software project demonstrating Python API development, transcript retrieval, retrieval-augmented generation, and LLM integration.
